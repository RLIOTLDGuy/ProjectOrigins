...
function bbox_in_camera_ext()
{
	...
	var cam_w = camera_get_view_width(argument0);
	var cam_h = camera_get_view_height(argument0);
	return rectangle_in_rectangle(bbox_left - argument1, bbox_top - argument1, bbox_right + bbox_right, bbox_bottom + argument1, cam_x, cam_y, cam_x + cam_w, cam_y + cam_h);
}
...
function camera_pos_get_struct(argument0, argument1 = -4) constructor
{
...
function camera_flash()
{
	global.pipebombflashbang = argument0;
}